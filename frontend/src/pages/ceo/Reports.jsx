      ...
      {!report ? (
        ...
        <>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            {/* "Shifokorlar KPI Ulushlari" bo'limi bu yerdan olib tashlandi —
                u statsionar daromadini hisobga olmagani uchun 10-kunlik
                asosiy hisobotdagi (tekshirilgan, to'g'irlangan) raqamlar
                bilan mos kelmasdi. To'g'ri ma'lumot endi faqat 10-kunlik
                hisobot sahifasida (UnifiedReportsHub) ko'rsatiladi. */}
